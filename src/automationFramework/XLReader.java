...
public class XLReader {
	...
	public void setExcelFile(String Path, String SheetName) throws Exception {
		...
		try {
			...
			System.out.println("Excel Sheet selected is: " + SheetName);
	...
	public String getCellData(int RowNum, int ColNum) throws Exception {
		...
		try {
			...
			/*
			 * String CellData = Cell.getStringCellValue(); System.out.println(
	...
	public void setCellData(String Result, int RowNum, int ColNum) throws Exception {
		...
		try {
			// HSSFSheet OutputSheet = ExcelWBook.getSheet("Output");
			...
			if (Cell == null) {
				...
				System.out.println("Booking Ref. stored is: " + Cell.getRichStringCellValue());
			...
			FileOutputStream fileOut = new FileOutputStream(
					EnvConfiguration.Path_TestData + EnvConfiguration.File_TestData);
