	...
	public void TC_RG_SLC_Validate_CheckIn_CheckOut() throws Exception {
	  ...
	  public void TC_RG_SLC_Search_By_Hotel_Name() throws Exception { 
		  try{ 
			  ...
			  String hotel =  excel.getCellData(4, 2); 
			  pgAct.Enter_HotelName(hotel); 
			  ...
			  pgAct.select_Adults(adult); Thread.sleep(3000); 
			  ...
			  //Verify search results list coming or not
			  Assert.assertTrue(Driver.driver.findElement(By.xpath(".//*[@id='supplieraddress']/h1")).getText().contains(hotel)); 
			  }
		  catch(Exception e) { 
			  e.getCause(); 
			  e.printStackTrace(); 
	  ...
	  { 
	   try{ 
		  ...
		  //Verify search results list coming or not
		  Assert.assertTrue(Driver.driver.findElement(By.xpath(".//*[@id='toolbar']/div").className("no_results")).isDisplayed(),
