...
public class DatePicker {
	...
	@Test
	public void testDAtePicker(String dateTime) throws Exception {
		...
		List<WebElement> allTime = driver.findElements(By.xpath(
				"//div[@data-role='popup'][contains(@style,'display: block')]//ul//li[@role='option']"));
